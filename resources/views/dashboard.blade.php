                ...
                <div class="item-card flex flex-col gap-y-10 md:flex-row justify-start gap-x-10 items-center">
                    ...
                    @role('owner|pemohon_penggalangan')
                        ...
                        <div class="flex flex-col gap-y-3">
                            ...
                            {{-- <div>
                                <p class="text-slate-500 text-sm">Proyek Penggalangan</p>
                                <h3 class="text-indigo-950 text-xl font-bold"> {{ $proyek_penggalangan }}</h3>
                            </div> --}}
                        </div>
                        ...
                        <div class="flex flex-col gap-y-3">
                            ...
                            {{-- <div>
                                <p class="text-slate-500 text-sm">Penarikan Dana</p>
                                <h3 class="text-indigo-950 text-xl font-bold"> {{ $penarikan_dana }} </h3>
                            </div> --}}
                        </div>
                    @endrole
                    ...
                    @role('owner')
                        <div class="flex flex-col gap-y-3">
                            ...
                            {{-- <div>
                                <p class="text-slate-500 text-sm">pemohon_penggalangan</p>
                                <h3 class="text-indigo-950 text-xl font-bold"> {{ $pemohon_penggalangan }} </h3>
                            </div> --}}
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            {{-- <div>
                                ...
                                <h3 class="text-indigo-950 text-xl font-bold"> {{ $kategori }} </h3>
                            </div> --}}
                        </div>
                    @endrole
