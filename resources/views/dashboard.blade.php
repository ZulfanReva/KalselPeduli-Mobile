            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                    ...
                    @role('owner')
                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">Pemohon Penggalangan</p>
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $pemohonPenggalangan }}</h3>
                            </div>
                        </div>
                    @endrole
                    ...
                    @role('owner|pemohon_penggalangan')
                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $proyekPenggalangan }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $penarikanDana }}</h3>
                            </div>
                        </div>
                    @endrole
