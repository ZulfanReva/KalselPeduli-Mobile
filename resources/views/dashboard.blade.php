                    ...
                    @role('owner')
                        <div class="flex items-center gap-x-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">{{ $kategori }}</h3>
                            </div>
                        </div>
                        <div class="flex items-center gap-x-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="flex items-center gap-x-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.4"
                                    ...
                                    fill="#292 IE4" class="dark:fill-gray-400" />
                                <path
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">Donatur</p>
                                <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">{{ $donatur }}</h3>
                            </div>
                        </div>
                        <div class="flex items-center gap-x-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">Proyek Penggalangan</p>
                                <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">{{ $proyekPenggalangan }}
                                </h3>
                            </div>
                        </div>
                        <div class="flex items-center gap-x-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#292D32" class="dark:fill-gray-400" />
                                <path d="M19 11.8599H2V13.3599H19V11.8599Z" fill="#292D32" class="dark:fill-gray-400" />
                            </svg>
                            <div>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">Penarikan Dana</p>
                                <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">{{ $penarikanDana }}</h3>
                            </div>
                        </div>
                    @endrole
                </div>
