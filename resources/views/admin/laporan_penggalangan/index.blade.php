    ...
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Kelola Laporan Penggalangan') }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div>
                        <p class="text-slate-500 dark:text-gray-400 text-sm">Jumlah Donasi</p>
                        <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">Rp 183409</h3>
                    </div>
                    <div>
                        <p class="text-slate-500 dark:text-gray-400 text-sm">Dibuat Pada</p>
                        <h3 class="text-indigo-950 dark:text-gray-200 text-xl font-bold">12 Jan 2024</h3>
                    </div>
